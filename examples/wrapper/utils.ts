 ...
 */
async function demonstrateUtilsWrapper() {
  // Initialize scanner for mainnet
  const utils = new UtilsWrapper(MODULE_OPTIONS.MAINNET);

  try {
    console.log("=== Utils Wrapper Demonstration ===");
...
if (require.main === module) {
  demonstrationWrapper("Utils module", demonstrateUtilsWrapper);
}
