 ...
 */
async function demonstrateNFTWrapper() {
  // Initialize scanner for mainnet
  const nft = new NFTWrapper(MODULE_OPTIONS.MAINNET);

  try {
    console.log("=== NFT Wrapper Demonstration ===");
...
if (require.main === module) {
  demonstrationWrapper("NFT module", demonstrateNFTWrapper);
}
