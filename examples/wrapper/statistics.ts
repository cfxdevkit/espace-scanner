import { StatisticsWrapper } from "../../src";
import {
  TEST_ADDRESSES,
  getTimeParams,
  inspect,
 ...
 */
async function demonstrateStatisticsWrapper() {
  // Initialize scanner for mainnet
  const statistics = new StatisticsWrapper(MODULE_OPTIONS.MAINNET);

  try {
    console.log("=== Statistics Wrapper Demonstration ===");
...
if (require.main === module) {
  demonstrationWrapper("Statistics module", demonstrateStatisticsWrapper);
}
