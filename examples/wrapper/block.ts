import { BlockWrapper, DateFormatter } from "../../src";
 ...
 */
async function demonstrateBlockWrapper() {
  // Initialize scanner for mainnet
  const block = new BlockWrapper(MODULE_OPTIONS.MAINNET);
...
if (require.main === module) {
  demonstrationWrapper("Block module", demonstrateBlockWrapper);
}
