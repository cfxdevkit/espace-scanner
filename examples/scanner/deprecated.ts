import { DeprecatedModule } from "../../src";
import {
  TEST_ADDRESSES,
  PAGINATION,
  inspect,
 ...
 */
async function demonstrateDeprecatedModule() {
  // Initialize scanner for mainnet
  const deprecated = new DeprecatedModule(MODULE_OPTIONS.MAINNET);

  try {
    console.log("=== Deprecated Module Demonstration ===");
...
if (require.main === module) {
  demonstrationWrapper("Deprecated module", demonstrateDeprecatedModule);
}
